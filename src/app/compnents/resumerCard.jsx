...
export default function ResumeCard({ title, years, para }) {
  return (
    ...
    whileHover={{ rotateY: 15, rotate: -0.5 }}
     className="group relative p-6 md:p-8 rounded-[2rem] bg-[#0f172a]/30 border border-slate-800 transition-all duration-500 hover:border-cyan-500/30 hover:bg-[#0f172a]/50">
